        ...
        var t = function () {
            ...
            var Y = function (e, t, s, n, r, o, i) {
                ...
                I.extend(a, i), I.extend(a, {
                    success: function (a) {
                        var u = new J;
                        u.szIP = e, 2 == t ? (u.szHttpProtocol = "https://", u.iHttpsPort = s) : (u.szHttpProtocol = "http://", u.iHttpPort = s), u.iCGIPort = s, u.szAuth = n, u.iDeviceProtocol = r, u.oProtocolInc = o, l.push(u), Z("使用%s协议登录成功", r), N(u), i.success && i.success(a)
                    }, error: function (e, t) {
                        i.error && i.error(e, t)
                    }
                }), o.login(e, s, n, a)
            ...
            this.I_Login = function (e, t, s, n, r, o) {
                    ...
                    I.extend(l, o), I.extend(l, {
                        error: function (i, l) {
                            ...
                            I.extend(p, o), I.extend(p, {
                                error: function () {
                                    if (!W(o.cgi))return o.error && o.error(i, l), void 0;
                ...
                var n = this.findDeviceIndexByIP(e), r = -1, o = "", i = "", a = -1, u = 0, d = 0, P = !1, h = {
                    iWndIndex: c,
                    iStreamType: 1,
                    iChannelID: 1,
                    bZeroChannel: !1
                ...
                return -1 != s && (n = u.HWP_SetVolume(t, e)), n
                ...
                var n = this.findDeviceIndexByIP(e), r = -1, o = "", i = "", a = -1, u = 1, p = I.dateFormat(new Date, "yyyy-MM-dd"), d = {
                    iWndIndex: c,
                    iChannelID: 1,
                ...
                if (I.extend(d, t), -1 != n) {
                    ...
                    if (h == R && P.oStreamCapa.bSupportShttpPlay ? (o = W(d.oTransCodeParam) ? P.oProtocolInc.CGI.startShttpPlayback : P.oProtocolInc.CGI.startTransCodePlayback, i = "http://", u = d.iChannelID <= P.iAnalogChannelNum ? d.iChannelID : P.oStreamCapa.iIpChanBase + parseInt(d.iChannelID, 10) - P.iAnalogChannelNum - 1, W(d.iPort) ? "https://" == P.szHttpProtocol ? (-1 == P.iHttpPort && (P.iHttpPort = B(P).iHttpPort), a = P.iHttpPort) : a = P.iCGIPort : (P.iHttpPort = d.iPort, a = d.iPort)) : (o = P.oProtocolInc.CGI.startPlayback, i = "rtsp://", u = 100 * d.iChannelID + 1, W(d.iPort) || (P.iRtspPort = d.iPort), -1 == P.iRtspPort && (P.iRtspPort = B(P).iRtspPort), a = P.iRtspPort), -1 == a)return Z("获取端口号失败"), r;
                    I.extend(d, {
                        urlProtocol: i,
                        cgi: o,
                        iPort: a,
                ...
                if (I.extend(d, t), -1 != n) {
                    j(l[n]);
                    var P = l[n], h = parseInt(s.$XML(m).find("ProtocolType").eq(0).text(), 10);
                    if (h == R && P.oStreamCapa.bSupportShttpPlay ? (o = P.oProtocolInc.CGI.startShttpReversePlayback, i = "http://", u = d.iChannelID <= P.iAnalogChannelNum ? d.iChannelID : P.oStreamCapa.iIpChanBase + parseInt(d.iChannelID, 10) - P.iAnalogChannelNum - 1, W(d.iPort) ? "https://" == P.szHttpProtocol ? (-1 == P.iHttpPort && (P.iHttpPort = B(P).iHttpPort), a = P.iHttpPort) : a = P.iCGIPort : (P.iHttpPort = d.iPort, a = d.iPort)) : (o = P.oProtocolInc.CGI.startPlayback, i = "rtsp://", u = 100 * d.iChannelID + 1, W(d.iPort) || (P.iRtspPort = d.iPort), -1 == P.iRtspPort && (P.iRtspPort = B(P).iRtspPort), a = P.iRtspPort), -1 == a)return Z("获取端口号失败"), r;
                    I.extend(d, {
                        urlProtocol: i,
                        cgi: o,
                        iPort: a,
                ...
                if (I.extend(o, t), -1 != s) {
                    ...
                    if (":" == I.Base64.decode(i.szAuth)[0])var a = I.Base64.decode(i.szAuth).split(":")[1], c = I.Base64.decode(i.szAuth).split(":")[2]; else var a = I.Base64.decode(i.szAuth).split(":")[0], c = I.Base64.decode(i.szAuth).split(":")[1];
            ...
            et.prototype.m_httpRequestSet = [], et.prototype.setRequestParam = function (e) {
                ...
                for (var s = null, n = 0; this.m_httpRequestSet.length > n; n++)if (e == this.m_httpRequestSet[n].iRequestID) {
            ...
            tt.prototype.CGI = {
                ...
                var o = 2 == r.protocol ? "https://" : "http://", i = k(this.CGI.login, o, e, t), a = new et, u = {
                    type: "GET",
                    url: i,
                    auth: n,
                    success: null,
                ...
                var s = k(this.CGI.getAudioInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "GET",
                    url: s,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = k(this.CGI.getDeviceInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new et, o = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = k(this.CGI.getAnalogChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new et, o = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = k(this.CGI.getDigitalChannel, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new et, o = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                if (this.getDigitalChannel(e, {
                        async: !1, success: function (e) {
                            ...
                            for (var t = s.$XML(n).find("InputProxyChannel", !0), o = 0, i = t.length; i > o; o++) {
                                var a = t[o], u = s.$XML(a).find("id").eq(0).text(), c = s.$XML(a).find("name").eq(0).text();
                                r[u] = c
                            }
                        }, error: function (e, s) {
                            t.error && t.error(e, s)
                    ...
                    var o = k(this.CGI.getDigitalChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), i = new et, a = {
                        type: "GET",
                        url: o,
                        auth: e.szAuth,
                        success: null,
                    ...
                    I.extend(a, t), I.extend(a, {
                        success: function (e) {
                            ...
                            for (var o = s.$XML(e).find("InputProxyChannelStatus", !0), i = 0, a = o.length; a > i; i++) {
                                var u = o[i], c = s.$XML(u).find("id").eq(0).text();
                ...
                var s = k(this.CGI.getZeroChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "GET",
                    url: s,
                    auth: e.szAuth,
                    success: null,
                ...
                var s = k(this.CGI.getPPPoEStatus, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "GET",
                    url: s,
                    auth: e.szAuth,
                    success: null,
                ...
                var s = k(this.CGI.getUPnPPortStatus, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "GET",
                    url: s,
                    auth: e.szAuth,
                    success: null,
                ...
                var s = k(this.CGI.getNetworkBond, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "GET",
                    url: s,
                    auth: e.szAuth,
                    success: null,
                ...
                var s = k(this.CGI.getNetworkInterface, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "GET",
                    url: s,
                    auth: e.szAuth,
                    success: null,
                ...
                var s = k(this.CGI.getPortInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "GET",
                    url: s,
                    auth: e.szAuth,
                    success: null,
                ...
                var s = k(this.CGI.startVoiceTalk.open, e.szHttpProtocol, e.szIP, e.iCGIPort, t), n = k(this.CGI.startVoiceTalk.close, e.szHttpProtocol, e.szIP, e.iCGIPort, t), r = k(this.CGI.startVoiceTalk.audioData, e.szHttpProtocol, e.szIP, e.iCGIPort, t), o = u.HWP_StartVoiceTalk(s, n, r, e.szAuth, e.iAudioType);
                return o
                ...
                s.bPTZAuto && this.ptzAutoControl(e, !0, s, {iPTZSpeed: 0}), n.iPTZSpeed = t ? 0 : 7 > n.iPTZSpeed ? 15 * n.iPTZSpeed : 100;
                var i = [{}, {pan: 0, tilt: n.iPTZSpeed}, {pan: 0, tilt: -n.iPTZSpeed}, {
                    ...
                    pan: n.iPTZSpeed,
                    tilt: -n.iPTZSpeed
                }, {}, {speed: n.iPTZSpeed}, {speed: -n.iPTZSpeed}, {speed: n.iPTZSpeed}, {speed: -n.iPTZSpeed}, {speed: n.iPTZSpeed}, {speed: -n.iPTZSpeed}], a = "", u = {};
                switch (n.iPTZIndex) {
                    case 1:
                    case 2:
                    case 3:
                    ...
                    case 15:
                        ...
                        break;
                    default:
                        return W(n.error) && n.error(), void 0
                }
                ...
                var r = "", o = "", i = n.iChannelID, a = n.szStartTime.replace(" ", "T") + "Z", u = n.szEndTime.replace(" ", "T") + "Z";
                ...
                var c = new et, l = {type: "POST", url: r, auth: e.szAuth, data: o, success: null, error: null};
                I.extend(l, n), I.extend(l, {
                    success: function (e) {
                        var t = [];
                ...
                var s = t.iWndIndex, n = t.szStartTime, r = t.szEndTime, o = k(t.cgi, t.urlProtocol, e.szIP, t.iPort, t.iChannelID, n, r), i = u.HWP_ReversePlay(o, e.szAuth, s, n, r);
                if (0 == i) {
                    var a = new Q;
                ...
                var s = k(this.CGI.restart, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "PUT",
                    url: s,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = k(this.CGI.restore, e.szHttpProtocol, e.szIP, e.iCGIPort, t), r = new et, o = {
                    type: "PUT",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var a = I.loadXML(n), u = parseInt(s.$XML(a).find("StartPoint").eq(0).find("positionX").eq(0).text(), 10), c = parseInt(s.$XML(a).find("StartPoint").eq(0).find("positionY").eq(0).text(), 10), l = parseInt(s.$XML(a).find("EndPoint").eq(0).find("positionX").eq(0).text(), 10), p = parseInt(s.$XML(a).find("EndPoint").eq(0).find("positionY").eq(0).text(), 10), d = "<?xml version='1.0' encoding='UTF-8'?><position3D><StartPoint><positionX>" + u + "</positionX>" + "<positionY>" + (255 - c) + "</positionY>" + "</StartPoint>" + "<EndPoint>" + "<positionX>" + l + "</positionX>" + "<positionY>" + (255 - p) + "</positionY>" + "</EndPoint>" + "</position3D>", P = new et, h = {
                    type: "PUT",
                    url: i,
                    data: d,
                    auth: e.szAuth,
                ...
                var s = k(this.CGI.SDKCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "GET",
                    url: s,
                    auth: e.szAuth,
                    success: null,
            ...
            st.prototype.CGI = {
                ...
                var n = k(this.CGI.getPortInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new et, o = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                I.extend(o, t), I.extend(o, {
                    success: function (n) {
                        ...
                        for (var o = s.$XML(n).find("AdminAccessProtocol", !0), i = 0, a = o.length; a > i; i++)o[i], r.push("<AdminAccessProtocol>"), r.push("<id>" + s.$XML(n).find("id").eq(0).text() + "</id>"), r.push("<enabled>" + s.$XML(n).find("enabled").eq(0).text() + "</enabled>"), r.push("<protocol>" + s.$XML(n).find("protocol").eq(0).text().toUpperCase() + "</protocol>"), r.push("<portNo>" + s.$XML(n).find("portNo").eq(0).text() + "</portNo>"), r.push("</AdminAccessProtocol>");
                ...
                var s = k(this.CGI.getStreamDynChannels, e.szHttpProtocol, e.szIP, e.iCGIPort), n = new et, r = {
                    type: "GET",
                    url: s,
                    auth: e.szAuth,
                    success: null,
                ...
                var r = s.iChannelID, o = "", i = "";
                if (n.iPTZSpeed = 7 > n.iPTZSpeed ? 15 * n.iPTZSpeed : 100, t && (n.iPTZSpeed = 0), e.szDeviceType != X)o = k(this.CGI.ptzAutoControl, e.szHttpProtocol, e.szIP, e.iCGIPort, r), i = "<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>" + n.iPTZSpeed + "</pan>" + "<tilt>0</tilt>" + "</PTZData>"; else {
                    var a = 99;
                ...
                var o = [{}, {pan: 0, tilt: n.iPTZSpeed}, {pan: 0, tilt: -n.iPTZSpeed}, {
                    ...
                    pan: n.iPTZSpeed,
                    tilt: -n.iPTZSpeed
                }, {}, {speed: n.iPTZSpeed}, {speed: -n.iPTZSpeed}, {speed: n.iPTZSpeed}, {speed: -n.iPTZSpeed}, {speed: n.iPTZSpeed}, {speed: -n.iPTZSpeed}], i = "", a = {};
                switch (n.iPTZIndex) {
                    case 1:
                    case 2:
                    case 3:
                ...
                var s = t.iWndIndex, n = t.szStartTime, r = t.szEndTime, o = k(t.cgi, t.urlProtocol, e.szIP, t.iPort, t.iChannelID, n, r), i = u.HWP_Play(o, e.szAuth, s, n, r);
                if (0 == i) {
                    var a = new Q;
                ...
                var r = k(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID), o = new et, i = {
                    type: "PUT",
                    url: r,
                    data: s,
                    auth: e.szAuth,
            ...
            rt.prototype.extend = function () {
                ...
                var e = /(webkit)[ \/]([\w.]+)/, t = /(opera)(?:.*version)?[ \/]([\w.]+)/, s = /(msie) ([\w.]+)/, n = /(trident.*rv:)([\w.]+)/, r = /(mozilla)(?:.*? rv:([\w.]+))?/, o = navigator.userAgent.toLowerCase(), i = e.exec(o) || t.exec(o) || s.exec(o) || n.exec(o) || 0 > o.indexOf("compatible") && r.exec(o) || ["unknow", "0"];
                ...
                encode: function (e) {
                    ...
                    for (e = rt.prototype.Base64._utf8_encode(e); e.length > c;)t = e.charCodeAt(c++), s = e.charCodeAt(c++), n = e.charCodeAt(c++), r = t >> 2, o = (3 & t) << 4 | s >> 4, i = (15 & s) << 2 | n >> 6, a = 63 & n, isNaN(s) ? i = a = 64 : isNaN(n) && (a = 64), u = u + this._keyStr.charAt(r) + this._keyStr.charAt(o) + this._keyStr.charAt(i) + this._keyStr.charAt(a);
                    return u
                },
                decode: function (e) {
                    var t, s, n, r, o, i, a, u = "", c = 0;
                    for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); e.length > c;)r = this._keyStr.indexOf(e.charAt(c++)), o = this._keyStr.indexOf(e.charAt(c++)), i = this._keyStr.indexOf(e.charAt(c++)), a = this._keyStr.indexOf(e.charAt(c++)), t = r << 2 | o >> 4, s = (15 & o) << 4 | i >> 2, n = (3 & i) << 6 | a, u += String.fromCharCode(t), 64 != i && (u += String.fromCharCode(s)), 64 != a && (u += String.fromCharCode(n));
                ...
                _utf8_decode: function (e) {
                    for (var t = "", s = 0, n = c1 = c2 = 0; e.length > s;)n = e.charCodeAt(s), 128 > n ? (t += String.fromCharCode(n), s++) : n > 191 && 224 > n ? (c2 = e.charCodeAt(s + 1), t += String.fromCharCode((31 & n) << 6 | 63 & c2), s += 2) : (c2 = e.charCodeAt(s + 1), c3 = e.charCodeAt(s + 2), t += String.fromCharCode((15 & n) << 12 | (63 & c2) << 6 | 63 & c3), s += 3);
                    return t
                }
